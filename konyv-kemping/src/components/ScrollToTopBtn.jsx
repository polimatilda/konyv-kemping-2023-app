...
function ScrollToTopBtn() {
  ...
  return (
    <Button onClick={handleClick} className="position-fixed back-to-top-btn">
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-up-square d-flex align-self-center" viewBox="0 0 16 16">
